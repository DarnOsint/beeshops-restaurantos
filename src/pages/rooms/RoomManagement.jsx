            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {filteredRooms.map((room) => {
                ...
                const hoursLeft = stay
                  ? Math.round((new Date(stay.check_out_at) - new Date()) / (1000 * 60 * 60))
                  : null
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span
                        className={`text-xs px-2 py-0.5 rounded-lg border ${cfg.color} capitalize`}
                      >
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex gap-1">
                        ...
                        {room.status !== 'maintenance' && room.status !== 'occupied' && (
                          <button
                            onClick={() => updateRoomStatus(room, 'maintenance')}
            ...
            {stays.length === 0 ? (
              ...
              stays.map((stay) => {
                const hoursLeft = Math.round(
                  (new Date(stay.check_out_at) - new Date()) / (1000 * 60 * 60)
                )
        ...
        {activeTab === 'settings' && (
          <div className="space-y-3 max-w-3xl">
            <p className="text-gray-400 text-sm mb-4">
              Click a room to edit its rate, type and details.
            </p>
            {rooms.map((room) => (
              <div
                key={room.id}
            ...
            <div className="flex items-center justify-between p-5 border-b border-gray-800 shrink-0">
              <div>
                ...
                <p className="text-amber-400 text-sm">
                  ₦{selectedRoom.rate_per_night?.toLocaleString()}/night
                </p>
              </div>
              <button
            ...
            <div className="p-5 space-y-4 overflow-y-auto flex-1">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCheckinForm({ ...checkinForm, guest_phone: e.target.value })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl pl-9 pr-4 py-3 focus:outline-none focus:border-amber-500 text-sm"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCheckinForm({ ...checkinForm, id_number: e.target.value })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl pl-9 pr-4 py-3 focus:outline-none focus:border-amber-500 text-sm"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="number"
                      min="1"
                      value={checkinForm.num_guests}
                      onChange={(e) =>
                        setCheckinForm({ ...checkinForm, num_guests: e.target.value })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl pl-9 pr-4 py-3 focus:outline-none focus:border-amber-500 text-sm"
                    />
                  </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCheckinForm({ ...checkinForm, check_in_at: e.target.value })
                    }
                    className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-amber-500 text-sm"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCheckinForm({ ...checkinForm, nights: e.target.value })}
                    className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-amber-500 text-sm"
                  />
                </div>
              </div>
              ...
              <div className="bg-gray-800 rounded-xl p-3 flex items-center justify-between text-sm">
                ...
                <span className="text-white font-medium">
                  {new Date(checkoutTime()).toLocaleString('en-NG', {
                    day: '2-digit',
                    month: 'short',
                    year: 'numeric',
                    hour: '2-digit',
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <button
                    key={m.id}
                    onClick={() => setCheckinForm({ ...checkinForm, payment_method: m.id })}
              ...
              <div>
                ...
                <input
                  value={checkinForm.payment_reference}
                  onChange={(e) =>
                    setCheckinForm({ ...checkinForm, payment_reference: e.target.value })
                  }
                  className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-amber-500 text-sm"
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex items-center justify-between">
                <div>
                  <p className="text-gray-400 text-xs">
                    {checkinForm.nights} night{checkinForm.nights > 1 ? 's' : ''} × ₦
                    {selectedRoom.rate_per_night?.toLocaleString()}
                  </p>
              ...
              >
                <CheckCircle size={16} />{' '}
                {saving ? 'Processing...' : `Confirm Check-in — ₦${totalAmount().toLocaleString()}`}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 rounded-2xl w-full max-w-sm border border-gray-800">
            ...
            <div className="p-5 space-y-4">
              ...
              <button
                onClick={() => processCheckout(selectedRoom)}
                disabled={saving}
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 rounded-2xl w-full max-w-sm border border-gray-800">
            <div className="flex items-center justify-between p-5 border-b border-gray-800">
              ...
              <button
                onClick={() => setShowStayDetail(false)}
                className="text-gray-400 hover:text-white"
              >
                <X size={20} />
              </button>
          ...
          <div className="bg-gray-900 rounded-2xl w-full max-w-md border border-gray-800">
            ...
            <div className="p-5 space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setRoomEditForm({ ...roomEditForm, room_type: e.target.value })
                    }
              ...
              <div>
                ...
                <input
                  type="number"
                  value={roomEditForm.rate_per_night}
                  onChange={(e) =>
                    setRoomEditForm({ ...roomEditForm, rate_per_night: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  value={roomEditForm.amenities}
                  onChange={(e) => setRoomEditForm({ ...roomEditForm, amenities: e.target.value })}
                  className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-amber-500 text-sm"
              ...
              <div>
                <label className="text-gray-500 text-xs block mb-1">Notes</label>
                <textarea
                  value={roomEditForm.notes}
                  onChange={(e) => setRoomEditForm({ ...roomEditForm, notes: e.target.value })}
                  rows={2}
                  className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-amber-500 text-sm resize-none"
                />
              </div>
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between mb-2">
        ...
        <p className="text-gray-500 text-xs">
          Total: ₦{history.reduce((s, h) => s + (h.total_amount || 0), 0).toLocaleString()}
        </p>
      </div>
      {history.length === 0 ? (
