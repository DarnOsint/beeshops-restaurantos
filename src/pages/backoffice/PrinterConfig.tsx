...
`
                    ...
                    const batContent = [
                      ...
                      '    echo Download from: https://nodejs.org/dist/v20.11.0/node-v20.11.0-x64.msi',
                      ...
                      '(echo }) >> "C:\\BeeshopPrint\\config.json"',
                      '',
                      'REM Download NSSM (Non-Sucking Service Manager) to run as a real Windows Service',
                      'echo Downloading service manager...',
                      "powershell -Command \"Invoke-WebRequest -Uri 'https://nssm.cc/release/nssm-2.24.zip' -OutFile 'C:\\BeeshopPrint\\nssm.zip'\"",
                      "powershell -Command \"Expand-Archive -Path 'C:\\BeeshopPrint\\nssm.zip' -DestinationPath 'C:\\BeeshopPrint' -Force\"",
                      'copy /y "C:\\BeeshopPrint\\nssm-2.24\\win64\\nssm.exe" "C:\\BeeshopPrint\\nssm.exe" >nul',
                      'rmdir /s /q "C:\\BeeshopPrint\\nssm-2.24" 2>nul',
                      'del "C:\\BeeshopPrint\\nssm.zip" 2>nul',
                      '',
                      'REM Write server.js',
                      ...
                      '"C:\\BeeshopPrint\\nssm.exe" install BeeshopPrint "%NODEPATH%" "C:\\BeeshopPrint\\server.js"',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint AppDirectory "C:\\BeeshopPrint"',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint Start SERVICE_AUTO_START',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint DisplayName "Beeshop Print Server"',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint Description "Thermal printer server for Beeshops Place POS - Printer ' +
                        ip +
                        '"',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint AppStdout "C:\\BeeshopPrint\\service.log"',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint AppStderr "C:\\BeeshopPrint\\service.log"',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint AppRotateFiles 1',
                      '"C:\\BeeshopPrint\\nssm.exe" set BeeshopPrint AppRotateBytes 1048576',
                      '',
                      'REM Start the service',
                      'net start BeeshopPrint',
                      '',
                      'REM Verify',
                      ...
                      'echo.',
                      'echo ================================================',
                      'echo   SUCCESS! Print server installed as a',
                      'echo   Windows Service. It runs in the background',
                      'echo   permanently - even after closing all windows',
                      'echo   or logging out. Starts on boot automatically.',
                      'echo.',
                      'echo   Printer IP: ' + ip,
                      'echo   Server: http://localhost:6543',
                      'echo   Service name: BeeshopPrint',
                      'echo ================================================',
                      'echo.',
                      'pause',
                    ].join('\r\n')
